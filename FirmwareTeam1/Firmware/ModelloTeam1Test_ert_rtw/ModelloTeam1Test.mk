###########################################################################
## Makefile generated for component 'ModelloTeam1Test'. 
## 
## Makefile     : ModelloTeam1Test.mk
## Generated on : Thu Jun 15 16:43:31 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ModelloTeam1Test.elf
...
PRODUCT_NAME              = ModelloTeam1Test
MAKEFILE                  = ModelloTeam1Test.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/giova/OneDrive/Desktop/ProgettoEmbeddedFinale
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = ModelloTeam1Test_comp.rsp
CMD_FILE                  = ModelloTeam1Test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ModelloTeam1Test.elf
...
DEFINES_STANDARD = -DMODEL=ModelloTeam1Test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o ModelloTeam1Test.o ModelloTeam1Test_data.o mw_mbed_interface.o BufferedSerial.o blapp_support.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ModelloTeam1Test.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/ModelloTeam1Test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ModelloTeam1Test_data.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/ModelloTeam1Test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ModelloTeam1Test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
